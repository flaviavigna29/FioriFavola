        ...
        <div class="mx-1 px-1 mx-md-5 px-md-5">
            ...
            <div class="row justify-content-evenly">
                ...
                <div class="col-12 col-lg-5 bordo_contacts bg-white" data-aos="fade-zoom-in" data-aos-easing="ease-in-back"
                    ...
                    <form method="POST" action="{{route('submit')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col my-2">
                                <input name="name" class="form-control2" type="text" placeholder="Nome">
                            </div>
                            <div class="col my-2">
                                <input name="surname" class="form-control2" type="text" placeholder="Cognome">
                            </div>

                            <div class=" my-2">
                                <input name="email" class="form-control2" type="email" placeholder="email">
                            </div>

                            <div class="col-12 my-2">
                                <label for="exampleFormControlTextarea1">Inserisci il testo</label>
                                <textarea name="message" class="form-control2" id="exampleFormControlTextarea1" rows="3"></textarea>
                ...
                <div class="d-none d-lg-block col-lg-5 justify-content-center align-items-center text-center"
                    data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="150" data-aos-duration="200" data-aos-offset="0">
